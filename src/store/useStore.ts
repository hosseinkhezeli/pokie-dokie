...
export const useStore = create<State>((set) => ({
  ...
  deleteStory: (storyId) => set((state) => {
    ...
    const newCurrentStoryId = state.session.currentStoryId === storyId
  ...
  setCurrentStory: (storyId) => set((state) => ({
    session: state.session ? {
      ...state.session,
  ...
  addVote: (storyId, vote) => set((state) => ({
    session: state.session ? {
      ...state.session,
  ...
  setVotesRevealed: (revealed) => set((state) => ({
    session: state.session ? {
      ...state.session,
  ...
  setTimer: (duration, endTime) => set((state) => ({
    session: state.session ? {
      ...state.session,
